(function () {
    ...
    // :: Navbar
    $("#wromyNavbarToggler").on("click", function () {
    ...
    // :: Dropdown Menu
    $(".sidenav-nav").find("li.wromy-dropdown-menu").append("<div class='dropdown-trigger-btn'><i class='lni lni-chevron-down'></i></div>");
